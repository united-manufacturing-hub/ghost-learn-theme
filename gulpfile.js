...
(function () {
    ...
    =============================
    */
    var File_Name = 'ghost-learn.zip';
    var CSS_Files = [
        './node_modules/magnific-popup/dist/magnific-popup.css',
        './node_modules/slick-carousel/slick/slick.css',
        './node_modules/aos/dist/aos.css', 
        './node_modules/simptip/simptip.min.css',    
        './node_modules/prismjs/themes/prism.css',    
        './assets/css/ghost.typofix.css',  
        './assets/css/ghost-dropdown.css',  
    ...
    var Production_CSS_Files = [ 
        ...
        './dist/production/assets/css/simptip.min.css', 
    ...
    var Production_JS_Files = [ 
        ...
        './dist/production/assets/js/chart.min.js', 
...
return gulp.src('./dist/production/*.hbs') //file with tags for injection
    .pipe(inject(gulp.src(Production_JS_Files), {
        starttag: '<!-- gulp:{{ext}} -->',
        endtag: '<!-- endgulp -->',
        relative: true
    }))
    .pipe(gulp.dest('./dist/production')); //where index.hbs will be saved. Same dir for overwrite old one
})
...
return gulp.src('./dist/production/*.hbs')
...
gulp.watch('*.hbs', gulp.series('build_css')); 
gulp.watch('./**/*.hbs', gulp.series('build_css'));
